          ...
          <form action="{{ Route::has('products.index') ? route('products.index') : url('/products') }}" method="GET">
            ...
            <div class="relative">
              ...
              <input
                ...
                class="block w-full rounded-full border border-gray-200 bg-white py-2.5 pl-10 pr-4 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-200 focus:border-emerald-300"
              />
            </div>
          </form>
        </div>
